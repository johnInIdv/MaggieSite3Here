...
//completes pictures but with lines
...
var hSize = 2;//horiontal size when recreating
var vSize = 100;//vertical size when recreating
var hide = 1200;//length to move fresh image off the screen
var destroy = 600;//size after distortion
var distort = 8000;//amount of distortion to original.
